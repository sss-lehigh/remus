...
public:
  ...
  static const std::string result_as_string_header() {
    return "node_id,runtime,unlimited_stream,op_count,region_size,thread_count,node_count,qp_max,contains,insert,"
           "remove,lb,ub,count,runtime_ns,units,mean,stdev,min,p50,p90,p95,p99,p999,max\n";
  }
