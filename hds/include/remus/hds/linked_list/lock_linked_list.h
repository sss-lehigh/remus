...
template <typename T, int N, template <typename, int> typename node_pointer_> struct inplace_construct {
...
template <typename T, int N, template <typename, int> typename node_pointer_, typename Allocator,
...
public:
  ...
  template <typename Group> HDS_HOST_DEVICE bool contains(T x, Group &group) {
  ...
  template <typename Group> HDS_HOST_DEVICE bool insert(T x, Group &group) {
  ...
  template <typename Group> HDS_HOST_DEVICE bool remove(T x, Group &group) {
