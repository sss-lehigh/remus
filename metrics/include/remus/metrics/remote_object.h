...
/// Represents a remotely accessible memory region. Used to convey the necessary information for remote nodes to
/// interact with this memory, assuming that they have access to a QP that is connected to it.
class RemoteObject {
public:
  ...
  std::string serialize() { return as_json().dump(); }
