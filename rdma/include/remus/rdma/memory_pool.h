...
template <typename T> struct std::hash<remus::rdma::rdma_ptr<T>> {
  std::size_t operator()(const remus::rdma::rdma_ptr<T> &ptr) const {
...
#define LT(n) n, n, n, n, n, n, n, n, n, n, n, n, n, n, n, n
  ...
  remus::metrics::Summary<size_t> rdma_per_read_;
